...
import json
import warnings
import RPi.GPIO as GPIO  # Import GPIO library for the PIR sensor
...
def main():
    ...
    while True:
      ...
      #  print(f"Button State: {curr_state}, Previous State: {prev_state}")  # Debugging
        
        if curr_state == GPIO.HIGH and prev_state == GPIO.LOW: #GPIO.input(BUTTON_PIN) == GPIO.HIGH:
